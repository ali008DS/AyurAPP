...
function PanchkarmaAssignment() {
    ...
    const fetchData = async () => {
      try {
        ...
        const [utensilsRes, usersRes, currentMonthRes] = await Promise.all([
          ApiManager.getUtensils("panchkarmaInventory"),
          ApiManager.getUsers(),
          ApiManager.getCurrentMonthPanchkarmaInventory(),
        ]);
  ...
  const handleSubmit = async () => {
    ...
    try {
      setLoading(true);
      if (inventoryId) {
        await ApiManager.updatePanchkarmaInventory(inventoryId, {
          items,
        ...
        const response = await ApiManager.createPanchkarmaInventory({
          items,
          responsibleUser: responsibleUser || undefined,
          checkedUser: checkedUser || undefined,
        });
...
export default PanchkarmaAssignment;
