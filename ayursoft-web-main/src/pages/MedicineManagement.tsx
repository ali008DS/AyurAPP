...
import MedOpenDrawer from "../components/medicine-stock/open-stock-model";
import StockAdjustmentModal, {
  StockAdjustType,
} from "../components/medicine-stock/stock-adjustment-modal";
import EditStockModal from "../components/medicine-stock/edit-stock-modal";
...
function MedicineManagement() {
  ...
  useEffect(() => {
    const fetchStockAdjustments = async () => {
      ...
      try {
        const response = await ApiManager.getStockAdjustments();
  ...
  return (
    ...
    >
      <HeadingText name="Medicine Stock" />
